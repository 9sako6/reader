...
function repeatWithParagraphs(text: string, count: number): string {
  return Array.from({ length: count }, () => text).join("\n\n");
}
...
export const timingCorpus: TimingCorpusEntry[] = [
  { id: "ja-general", locale: "ja", text: `${repeat(jaGeneral, 5)}最後に、読み手が自分の速度を確かめられるようにします。` },
  { id: "ja-technical", locale: "ja", text: repeatWithParagraphs(jaTechnical, 5) },
  { id: "ja-dialogue", locale: "ja", text: repeatWithParagraphs(jaDialogue, 5) },
  { id: "ja-short-sentences", locale: "ja", text: repeat(jaShortSentences, 8) },
  { id: "ja-long-sentence", locale: "ja", text: repeat(jaLongSentence, 3) },
  { id: "mixed-code-numbers", locale: "ja", text: repeatWithParagraphs(mixedCodeNumbers, 4) },
  { id: "en-general", locale: "en", text: repeatWithParagraphs(enGeneral, 4) },
];
